...
public class CurseForgeActivity extends BaseActivity {
    ...
    private void initViews() {
        ...
        adapter = new CurseForgeContentAdapter(this::onContentClick);
    ...
    private void loadContent() {
        ...
        client.searchContent(query, category != null ? category.id : 0, "", 0, 50, sort != null ? sort.field : CurseForgeClient.SORT_POPULARITY, sort != null ? sort.order : "desc", new CurseForgeClient.CurseForgeCallback<ContentSearchResponse>() {
            @Override
